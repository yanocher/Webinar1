...
public class Main {
    ...
    public static void main(String[] args) {
        // ТЗ на доработки приложения
        // - вынести работу со сканером в отдельный метод
        // - добавить редактирование заметки (выводится текст заметки + вводится заметка с нуля)
        // - реализовать методы в классе Note
        // * добавить вывод даты и времени
